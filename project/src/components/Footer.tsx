      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Your destination for premium products with exceptional quality and modern design. 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Featured Products</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Deals & Offers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Customer Reviews</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@modernstore.com</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for exclusive deals and new arrivals</p>
            <div className="flex">
              <input
                type="email"
